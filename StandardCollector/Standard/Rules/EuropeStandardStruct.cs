...
{
    public class EuropeStandardStruct:StandardStruct
    {
        /// <summary>欧洲标准起始标记（EN）</summary>
        private string mark;
        ...
        public EuropeStandardStruct(string mark,string number,int year,string name)
        {
            this.mark = mark;
            this.number = number;
            this.year = year;
        ...
        /// <summary>欧洲标准起始标记。</summary>
        /// <remarks>应始终为EN。</remarks>
        public string Mark
        {
